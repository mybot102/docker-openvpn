...
- Современный набор шифров: AES-256-GCM, SHA256, tls-crypt
...
- Открытый в файрволе порт VPN (по умолчанию TCP 1194, или настроенный порт/протокол)
...
| `VPN_PROTO` | Протокол VPN: `udp` или `tcp` | `tcp` |
